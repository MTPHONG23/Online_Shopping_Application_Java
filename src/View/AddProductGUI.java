...
public class AddProductGUI extends JFrame {
	...
	public AddProductGUI() {
        ...
        JLabel jLabel4 = new JLabel("ADD PRODUCT");
        jLabel4.setFont(new Font("Tahoma", Font.BOLD, 24));
        jLabel4.setBounds(190, 32, 195, 30);
        jLabel4.setBackground(new Color(47, 60, 126));
        jPanel1.add(jLabel4);
        
        JLabel lblName = new JLabel("Name");
        lblName.setForeground(new Color(128, 128, 128));
        lblName.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblName.setBounds(34, 116, 80, 20);
        jPanel1.add(lblName);
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (jTextFieldNameProduct.getText().equals("")) {
                        ...
                        JOptionPane.showMessageDialog(jPanel1, "không được bỏ trống giá");
    ...
    private void jTextFieldQuantityKeyPressed(java.awt.event.KeyEvent evt) {
        ...
        if (Character.isLetter(c)) {
            ...
            JOptionPane.showMessageDialog(AddProductGUI.this, "Bạn vui lòng nhập số !!!");
        }else{
